...
namespace MVCSistemaDeElementos.Descriptores
{
    public class DescriptorDePuestosDeUnUsuario : DescriptorDeCrud<PuestosDeUnUsuarioDto>
    {
        ...
        : base(nameof(PuestosDeUnUsuarioController), nameof(PuestosDeUnUsuarioController.CrudPuestosDeUnUsuario), modo)
        {
            ...
            BuscarControlEnFiltro(FiltroPor.Nombre).CambiarAtributos(nameof(PuestosDeUnUsuarioDto.Puesto), "Buscar por 'puesto'");
            ...
            var opcion = new OpcionDeMenu<PuestosDeUnUsuarioDto>(Mnt.ZonaMenu.Menu, relacionarPuestos, $"Puestos");
