...
namespace MVCSistemaDeElementos.Descriptores
{
    public class DescriptorDePermisosDeUnRol : DescriptorDeCrud<PermisosDeUnRolDto>
    {
        ...
        : base(nameof(PermisosDeUnRolController), nameof(PermisosDeUnRolController.CrudPermisosDeUnRol), modo)
        {
            ...
            BuscarControlEnFiltro(FiltroPor.Nombre).CambiarAtributos("Permiso", nameof(PermisosDeUnRolDto.Permiso), "Buscar por 'permiso'");
            ...
            var opcion = new OpcionDeMenu<PermisosDeUnRolDto>(Mnt.ZonaMenu.Menu, relacionarPermisos, $"Permisos", enumModoDeAccesoDeDatos.Gestor, enumClaseOpcionMenu.DeVista);
