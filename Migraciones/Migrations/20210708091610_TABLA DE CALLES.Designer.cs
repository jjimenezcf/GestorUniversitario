...
namespace GestorDeEntorno.Migrations
{
    ...
    [Migration("20210708091610_TABLA DE CALLES")]
    partial class TABLADECALLES
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.AuditoriaDeUnCalleDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                    ...
                    b.HasIndex("IdElemento")
                        .HasDatabaseName("I_CALLE_AUDITORIA_ID_ELEMENTO");

                    b.HasIndex("IdUsuario")
                        .HasDatabaseName("I_CALLE_AUDITORIA_ID_USUARIO");

                    b.ToTable("CALLE_AUDITORIA", "CALLEJERO");
                });

            modelBuilder.Entity("ServicioDeDatos.Callejero.AuditoriaDeUnMunicipioDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                    ...
                    b.HasIndex("IdElemento")
                        .HasDatabaseName("I_MUNICIPIO_AUDITORIA_ID_ELEMENTO");

                    b.HasIndex("IdUsuario")
                        .HasDatabaseName("I_MUNICIPIO_AUDITORIA_ID_USUARIO");

                    b.ToTable("MUNICIPIO_AUDITORIA", "CALLEJERO");
                });
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.AuditoriaDeUnPaisDtm", b =>
                {
                    ...
                    b.HasIndex("IdElemento")
                        .HasDatabaseName("I_PAIS_AUDITORIA_ID_ELEMENTO");
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.CalleDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                    ...
                    b.Property<string>("Expresion")
                        ...
                        .HasComputedColumnSql("CALLEJERO.CC_CALLE_EXPRESION(NOMBRE, ID_MUNICIPIO, ID_TIPO_DE_VIA)");
                    ...
                    b.HasAlternateKey("IdMunicipio", "Codigo")
                        .HasName("AK_CALLE_ID_MUNICIPIO_CODIGO");
                    ...
                    b.HasIndex("IdUsuaCrea")
                        .HasDatabaseName("I_CALLE_IDUSUCREA");

                    b.HasIndex("IdUsuaModi")
                        .HasDatabaseName("I_CALLE_IDUSUMODI");

                    b.HasIndex("Nombre")
                        .HasDatabaseName("I_CALLE_NOMBRE");

                    b.ToTable("CALLE", "CALLEJERO");
                });

            modelBuilder.Entity("ServicioDeDatos.Callejero.CodigoPostalDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                    ...
                    b.Property<string>("NombreMunicipio")
                        ...
                        .HasComputedColumnSql("CALLEJERO.CC_CODIGO_POSTAL_MUNICIPIOS(CP)");

                    b.Property<string>("NombreProvincia")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("VARCHAR(250)")
                        .HasColumnName("PROVINCIA")
                        .HasComputedColumnSql("CALLEJERO.CC_CODIGO_POSTAL_PROVINCIA(CP)");

                    b.HasKey("Id");

                    b.HasAlternateKey("Codigo")
                        .HasName("AK_CODIGO_POSTAL_CP");

                    b.ToTable("CODIGO_POSTAL", "CALLEJERO");
                });

            modelBuilder.Entity("ServicioDeDatos.Callejero.CpsDeUnMunicipioDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                    ...
                    b.HasAlternateKey("IdCp", "IdMunicipio")
                        .HasName("AK_MUNICIPIO_CP");
                    ...
                    b.ToTable("MUNICIPIO_CP", "CALLEJERO");
                });

            modelBuilder.Entity("ServicioDeDatos.Callejero.CpsDeUnaProvinciaDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                    ...
                    b.HasAlternateKey("IdCp")
                        .HasName("AK_PROVINCIA_CP_ID_CP");
                    ...
                    b.ToTable("PROVINCIA_CP", "CALLEJERO");
                });

            modelBuilder.Entity("ServicioDeDatos.Callejero.MunicipioDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                    ...
                    b.HasAlternateKey("IdProvincia", "Codigo")
                        .HasName("AK_MUNICIPIO_ID_PROVINCIA_CODIGO");

                    b.HasIndex("IdProvincia")
                        .HasDatabaseName("I_MUNICIPIO_ID_PROVINCIA");

                    b.HasIndex("IdUsuaCrea")
                        .HasDatabaseName("I_MUNICIPIO_IDUSUCREA");

                    b.HasIndex("IdUsuaModi")
                        .HasDatabaseName("I_MUNICIPIO_IDUSUMODI");

                    b.HasIndex("Nombre")
                        .HasDatabaseName("I_MUNICIPIO_NOMBRE");

                    b.ToTable("MUNICIPIO", "CALLEJERO");
                });
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.PaisDtm", b =>
                {
                    ...
                    b.HasAlternateKey("Codigo")
                        .HasName("AK_PAIS_CODIGO");

                    b.HasAlternateKey("ISO2")
                        .HasName("AK_PAIS_ISO2");

                    b.HasAlternateKey("NombreIngles")
                        .HasName("AK_PAIS_NAME");
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.TipoDeViaDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                    ...
                    b.HasAlternateKey("Sigla")
                        .HasName("AK_TIPO_VIA_SIGLA");

                    b.HasIndex("Nombre")
                        .HasDatabaseName("I_TIPO_VIA_NOMBRE");

                    b.ToTable("TIPO_VIA", "CALLEJERO");
                });
            ...
            modelBuilder.Entity("ServicioDeDatos.Negocio.NegocioDtm", b =>
                {
                    ...
                    b.Property<string>("Enumerado")
                        .IsRequired()
                        .HasColumnType("VARCHAR(250)")
                        .HasColumnName("ENUMERADO");

                    b.Property<bool>("EsDeParametrizacion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIT")
                        .HasDefaultValue(false)
                        .HasColumnName("ES_DE_PARAMETRIZACION");
                    ...
                    b.Property<bool>("UsaSeguridad")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("BIT")
                        .HasDefaultValue(true)
                        .HasColumnName("USA_SEGURIDAD");
            ...
            modelBuilder.Entity("ServicioDeDatos.Negocio.ParametroDeNegocioDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
            ...
            modelBuilder.Entity("ServicioDeDatos.TrabajosSometidos.CorreoDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
                    ...
                    b.Property<string>("Receptores")
                        .IsRequired()
                        .HasColumnType("VARCHAR(2000)")
                        .HasColumnName("RECEPTORES");

                    b.HasKey("Id");

                    b.HasIndex("IdUsuario");

                    b.ToTable("CORREO", "TRABAJO");
                });
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.CalleDtm", b =>
                {
                    b.HasOne("ServicioDeDatos.Callejero.MunicipioDtm", "Municipio")
                        .WithMany()
                    ...
                    b.HasOne("ServicioDeDatos.Callejero.TipoDeViaDtm", "TipoDeVia")
                        .WithMany()
                    ...
                    b.HasOne("ServicioDeDatos.Entorno.UsuarioDtm", "UsuarioCreador")
                        .WithMany()
                        .HasForeignKey("IdUsuaCrea")
                        .HasConstraintName("FK_CALLE_IDUSUCREA")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("ServicioDeDatos.Entorno.UsuarioDtm", "UsuarioModificador")
                        .WithMany()
                        .HasForeignKey("IdUsuaModi")
                        .HasConstraintName("FK_CALLE_IDUSUMODI")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Municipio");

                    b.Navigation("TipoDeVia");
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.CpsDeUnMunicipioDtm", b =>
                {
                    b.HasOne("ServicioDeDatos.Callejero.CodigoPostalDtm", "CodigoPostal")
                        .WithMany("Municipios")
                        .HasForeignKey("IdCp")
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.CpsDeUnaProvinciaDtm", b =>
                {
                    ...
                    b.HasOne("ServicioDeDatos.Callejero.ProvinciaDtm", "Provincia")
                        .WithMany("Cps")
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.MunicipioDtm", b =>
                {
                    ...
                    b.HasOne("ServicioDeDatos.Entorno.UsuarioDtm", "UsuarioCreador")
                        .WithMany()
                        .HasForeignKey("IdUsuaCrea")
                        .HasConstraintName("FK_MUNICIPIO_IDUSUCREA")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("ServicioDeDatos.Entorno.UsuarioDtm", "UsuarioModificador")
                        .WithMany()
                        .HasForeignKey("IdUsuaModi")
                        .HasConstraintName("FK_MUNICIPIO_IDUSUMODI")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ServicioDeDatos.TrabajosSometidos.CorreoDtm", b =>
                {
                    b.HasOne("ServicioDeDatos.Entorno.UsuarioDtm", "Usuario")
                        .WithMany()
                        .HasForeignKey("IdUsuario")
                        .HasConstraintName("FK_TRABAJO_DE_USUARIO_ID_USUARIO")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
