...
namespace GestorDeEntorno.Migrations
{
    ...
    [Migration("20210401163822_Reajustar campos de auditoría")]
    partial class Reajustarcamposdeauditoría
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServicioDeDatos.Negocio.AuditoriaDtm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.AuditoriaDeUnPaisDtm", b =>
                {
                    b.HasBaseType("ServicioDeDatos.Negocio.AuditoriaDtm");
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.AuditoriaDeUnPaisDtm", b =>
                {
                    b.HasOne("ServicioDeDatos.Negocio.AuditoriaDtm", null)
                        .WithOne()
                        .HasForeignKey("ServicioDeDatos.Callejero.AuditoriaDeUnPaisDtm", "Id")
            ...
            modelBuilder.Entity("ServicioDeDatos.Callejero.AuditoriaDeUnaProvinciaDtm", b =>
                {
                    b.HasOne("ServicioDeDatos.Negocio.AuditoriaDtm", null)
                        .WithOne()
                        .HasForeignKey("ServicioDeDatos.Callejero.AuditoriaDeUnaProvinciaDtm", "Id")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
                });
