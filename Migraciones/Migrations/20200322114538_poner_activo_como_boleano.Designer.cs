...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gestor.Elementos.Entorno.R_Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Gestor.Elementos.Entorno.R_VistaMvc", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("Gestor.Elementos.Entorno.R_Menu", b =>
                {
                    b.HasOne("Gestor.Elementos.Entorno.R_Menu", "Padre")
                        .WithMany()
                        .HasForeignKey("IdPadre")
                        .HasConstraintName("FK_MENU_IDPADRE");

                    b.HasOne("Gestor.Elementos.Entorno.R_VistaMvc", "VistaMvc")
                        .WithMany("Menus")
